...
def run():
    ...
    while True:
        ...
        centralPoint,realPosition,RotationAngle = conter(frame)
        centralPoint = [0,0]
        print(centralPoint, realPosition, RotationAngle)
        frame = pl.draw_blank(blank = frame, coordinate_list=[centralPoint], color = (0, 255, 0))
